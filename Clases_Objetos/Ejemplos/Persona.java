...
public class Persona {
    ...
    Persona(String nombre, String apellidos, String númeroDocumentoIdentidad, int añoNacimiento, String pais_de_nacimiento, char genero) {
        this.nombre = nombre;
    ...
    */
    void imprimir() {
        ...
        System.out.println("Pais de nacimiento = " + pais_de_nacimiento);
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        Persona p2 = new Persona("Luis","León","1053223344",2001, "Brazil", 'M');
        p1.imprimir();
        p2.imprimir();
    }
}
