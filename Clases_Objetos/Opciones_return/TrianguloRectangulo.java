...
manera, es isósceles */
  ...
  public static void main(String[] args) {
    ...
    TrianguloRectangulo triangulo_rectangulo = new TrianguloRectangulo(5, 10);

    double area = triangulo_rectangulo.calcularArea();
    double perimetro = triangulo_rectangulo.calcularPerímetro();

    System.out.println("El area del triángulo rectángulo es: " + Math.round(area));
    System.out.println("El perímetro del triángulo rectángulo es: " + Math.round(perimetro));
  }
}
